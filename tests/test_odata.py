...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("startDate lt 2021-01-01T01:00:00", {1, 2}),
        ("startDate lt 2021-01-01T01:00:00.000Z", {1, 2}),
        ("startDate lt 2021-01-01T01:00:00.000000-07:00", {1, 2}),
        ("created gt 2020-05-01T01:00:00", {2, 3, 4}),
        ("created gt 2020-05-01T01:00:00.000Z", {2, 3, 4}),
        ("created lt 2021-01-01T04:00:00", {1, 2}),
        ("created lt 2021-01-01T04:00:00.000Z", {1, 2}),
        ("id in (1,3)", {1, 3}),
